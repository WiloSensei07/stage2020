...
<head>
	...
	<title>Preparation Exercise Bank</title>
...
<body class="home">
	...
	<header id="head">
		<div class="container">
			<div class="row">
				<h1 class="lead">WELCOME TO PEB</h1>
				<p class="tagline">Prepation Exercise Bank</p>
				<P>if you don't have account  please click to Register??</P>
				<p><a class="btn btn-default btn-lg" role="button" href="login.php">LOG IN</a> <a class="btn btn-action btn-lg" role="button"  href="inscription.php">REGISTER</a></p>
			</div>
		</div>
	</header>
	<!-- /Header -->
	...
	<div class="container text-center">
		<br> <br>
		<h2 class="thin">The best place of prepation for STUDENT </h2>
		<p class="text-muted">
	...
	<div class="jumbotron top-space">
		<div class="container">
			...
			<h3 class="text-center thin">Reasons to use PEB</h3>
					...
					<div class="col-md-6 widget">
						<div class="widget-body">
							<p class="simplenav">
								...
								<a href="principale.php">principale</a> 
							</p>
						</div>
					</div>
