...
<?php
	 if(isset($_POST['login'])){
		 if(isset($_POST['matricule']) && isset($_POST['pwd'])){
			$q = $db->prepare("SELECT * FROM users WHERE matricule = ? AND password = ?");
			$q->execute([$_POST['matricule'], $_POST['pwd']]);
				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<p class="text-center text-muted">If you don't have account please click to <a href="inscription.php">Register</a> and create your session </p>
							<hr>
							...
							<div class="form-group">
								...
								<div class="row">
									<div class="col-lg-8">
										<b><a href="">have you Forgot your password?</a></b>
									</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 widget">
						<div class="widget-body">
							<p class="text-right">
								Copyright &copy; 2020,  by rose Tchameni
							</p>
						</div>
					</div>
