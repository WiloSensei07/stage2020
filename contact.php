		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Test Pages <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="sidebar-left.php">Prepa 3il1</a></li>
							<li><a href="sidebar-right.php">Prepa 3il2</a></li>
							<li><a href="sidebar-left.php">TIC 1</a></li>
							<li><a href="sidebar-right.php">TIC 2</a></li>
						</ul>
					</li>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 widget">
						<div class="widget-body">
							<p class="text-right">
								Copyright &copy; 2020, rose Tchameni
							</p>
						</div>
					</div>
